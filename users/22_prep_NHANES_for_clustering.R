...
# Save the variables after removing correlated variables
  write.table(selected_variables, 
              "results/PCA_results/NHANES1516_totalsbyhand_FC_n98/NHANES1516_total_d12_FC_mean_QC_2_98diffdiet_rv.txt", 
...
# cc is the correlation matrix produced when variables are collapsed by correlation. 
  SaveCorrMatrix(x=cc, 
                 out.fn = "results/PCA_results/NHANES1516_totalsbyhand_FC_n98/NHANES1516_total_d12_FC_mean_QC_2_98diffdiet_corr_mat.txt")
  # ---------------------------------------------------------------------------------------------------------------
