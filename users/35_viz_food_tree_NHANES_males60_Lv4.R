# ===============================================================================================================
# Generate food tree out of GLU - males in their 60s with food level 4 (test)
# Version 1
...
# Load your tree object.
  tree <- read.tree("Food_D12_FC_cc_f_males60s_red_Lv4.nwk")
...
# Save.
  ggsave("Food_D12_FC_cc_f_males60s_red_Lv4_viz.pdf", annotated_tree,
