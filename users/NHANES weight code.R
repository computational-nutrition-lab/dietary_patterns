# ========================================================================================
# Tutorial code to Use NHANES weight.
# Version 1
# Copied from DB303 Depression Prevalence https://wwwn.cdc.gov/nchs/nhanes/tutorials/module6.aspx
# Created on 04/08/2022 by Rie Sadohara
# ========================================================================================
...
One <- left_join(DEMO, DPQ, by="SEQN") %>%
  ...
  mutate(. , 
         ...
         WTMEC4YR = WTMEC2YR/2 ,
         # Define indicator (T or F) for analysis population of interest: adults aged 20 and over with a valid depression score
...
# Define survey design for overall dataset; this is where weights are used.
