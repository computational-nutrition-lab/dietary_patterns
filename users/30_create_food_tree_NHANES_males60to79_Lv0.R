# ===============================================================================================================
# Generate food tree out of GLU - males in their 60-79
# Version 1
# Created on 10/30/2022 by Rie Sadohara
# ===============================================================================================================
...
# Load the males60to79 people. Note this is a total data (1 row/person).
  glu_3_males60to79 <- read.table("QCtotal_d_glu_body_meta_demo_males60to79.txt", 
                               sep="\t", header=T)
...
# "NodeLabelsMCT.txt" has a list of food levels and names, which comes with this package.
  MakeFoodTree(nodes_fn="../../Food_tree_eg/NodeLabelsMCT.txt", 
               ...
               output_tree_fn =     "Foodtree/Food_D12_FC_cc_f_males60to79_red_Lv0.nwk", 
               output_taxonomy_fn = "Foodtree/Food_D12_FC_cc_f_males60to79_red_Lv0.taxonomy.txt"
  ) 
...
# Make the standard food otu table with data in gram weights of food.
  MakeFoodOtu(food_records_fn=  "Food_D12_FC_cc_f_males60to79.txt",  # need to supply data that have 'FoodAmt' before applying FilterDBByDietRecords.  
              food_record_id =  "SEQN",                          # The ID of your participants
              food_taxonomy_fn= "Foodtree/Food_D12_FC_cc_f_males60to79_red_Lv0.taxonomy.txt",  # Your taxonomy file produced by MakeFoodTree.
              output_fn =       "Foodtree/Food_D12_FC_cc_f_males60to79_red_Lv0.food.otu.txt")  # Output otu file to be saved.

# Make a food otu table with data in grams of fiber per food
  MakeFiberOtu(food_records_fn=  "Food_D12_FC_cc_f_males60to79.txt", 
               food_record_id=   "SEQN", 
               food_taxonomy_fn= "Foodtree/Food_D12_FC_cc_f_males60to79_red_Lv0.taxonomy.txt", 
               output_fn=        "Foodtree/Food_D12_FC_cc_f_males60to79_red_Lv0.fiber.otu.txt")

# Make a food otu table as dehydrated grams per kcal
  MakeDhydrtOtu(food_records_fn=  "Food_D12_FC_cc_f_males60to79.txt", 
                food_record_id =  "SEQN", 
                food_taxonomy_fn= "Foodtree/Food_D12_FC_cc_f_males60to79_red_Lv0.taxonomy.txt", 
                output_fn =       "Foodtree/Food_D12_FC_cc_f_males60to79_red_Lv0.dhydrt.otu.txt")  

# ---------------------------------------------------------------------------------------------------------------
# make.food.tree and make.otu etc. still works with lv0. so... the functions are 
# off by 1! No wonder level=6 returns an error.
