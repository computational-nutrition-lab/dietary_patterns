...
# Create a phyloseq object out of dietary and tree data and run ordination. Food tree level 2
...
#   food <- read.delim("Foodtree/Food_D12_FC_cc_f_males60to79_red_Lv2.dhydrt.otu.txt", row.names=1)
...
# Food - copied from "40_ordination_NHANES_males60to79_Lv2_Euclidean_sortfood.R".
  # Load food OTU table - this is our food OTU data
  food_raw <- read.delim("Foodtree/Food_D12_FC_cc_f_males60to79_red_Lv2.dhydrt.otu.txt", row.names=1)
...
# Taxonomy (tax)
  ...
  tax <- read.delim("Foodtree/Food_D12_FC_cc_f_males60to79_red_Lv2.taxonomy.txt")
...
# Food tree
  ...
  foodtree <- read_tree("Foodtree/Food_D12_FC_cc_f_males60to79_red_Lv2.nwk")
...
# Save the percent variance explained as a txt file.
  Eigen(eigen.input = eigen_percent_w, 
        output.fn="Food_D12_FC_cc_f_males60to79_red_Lv2_ord_WEIGHTED_eigen.txt")
...
# The merged dataframe, 'meta_usersdf', will be used for plotting.
  MergeAxesAndMetadata_NHANES(ord.object= ordinated_w, number.of.axes= 10, meta.data= demog_glu, 
                              output.fn= "Food_D12_FC_cc_f_males60to79_red_Lv2_ord_WEIGHTED_meta_users.txt")
    # View(MergeAxesAndMetadata_NHANES)
    
# Load the output again for plotting.
  loaded_glu_w <- read.table("Food_D12_FC_cc_f_males60to79_red_Lv2_ord_WEIGHTED_meta_users.txt",
                             sep="\t", header=T)
...
# Save p1 as a png. 
  ggsave("Food_D12_FC_cc_f_males60to79_red_Lv2_ord_WEIGHTED_Axis12_p1.png", 
...
# Save ellipses as a png. 
  ggsave("Food_D12_FC_cc_f_males60to79_red_Lv2_ord_WEIGHTED_Axis12_ellipses.png", 
...
# Plot Axis 2 and Axis 3 to show the separation of samples colored by Groups as in the metadata.
  ...
  # Save p1 as a png. 
  ggsave("Food_D12_FC_cc_f_males60to79_red_Lv2_ord_WEIGHTED_Axis23_p1.png", 
         p1_w, device="png", width=7, height=5.5, unit="in", dpi=300)
  ...
  # Save ellipses as a png. 
  ggsave("Food_D12_FC_cc_f_males60to79_red_Lv2_ord_WEIGHTED_Axis23_ellipses.png", 
         ellipses_w, device="png", width=7, height=5.5, unit="in", dpi=300)
...
# Plot Axis 3 and Axis 4 to show the separation of samples colored by Groups as in the metadata.
  ...
  # Save p1 as a png. 
  ggsave("Food_D12_FC_cc_f_males60to79_red_Lv2_ord_WEIGHTED_Axis34_p1.png", 
         p1_w, device="png", width=7, height=5.5, unit="in", dpi=300)
  ...
  # Save ellipses as a png. 
  ggsave("Food_D12_FC_cc_f_males60to79_red_Lv2_ord_WEIGHTED_Axis34_ellipses.png", 
         ellipses_w, device="png", width=7, height=5.5, unit="in", dpi=300)  
...
# Plot Axis 2 and Axis 4 to show the separation of samples colored by Groups as in the metadata.
  ...
  # Save p1 as a png. 
  ggsave("Food_D12_FC_cc_f_males60to79_red_Lv2_ord_WEIGHTED_Axis24_p1.png", 
         p1_w, device="png", width=7, height=5.5, unit="in", dpi=300)
  ...
  # Save ellipses as a png. 
  ggsave("Food_D12_FC_cc_f_males60to79_red_Lv2_ord_WEIGHTED_Axis24_ellipses.png", 
         ellipses_w, device="png", width=7, height=5.5, unit="in", dpi=300)  
...
# Save the percent variance explained as a txt file.
  Eigen(eigen.input = eigen_percent_u, 
        output.fn="Food_D12_FC_cc_f_males60to79_red_Lv2_ord_UNweighted_eigen.txt")
...
# The merged dataframe, 'meta_usersdf', will be used for plotting.
  MergeAxesAndMetadata_NHANES(ord.object= ordinated_u, number.of.axes= 10, meta.data= demog_glu, 
                              output.fn= "Food_D12_FC_cc_f_males60to79_red_Lv2_ord_UNweighted_meta_users.txt")
  
# Load the output again for plotting.
  loaded_glu_u <- read.table("Food_D12_FC_cc_f_males60to79_red_Lv2_ord_UNweighted_meta_users.txt",
                             sep="\t", header=T)  
...
# Save p1 as a png. 
  ggsave("Food_D12_FC_cc_f_males60to79_red_Lv2_ord_UNweighted_Axis12_p1.png", 
...
# Save ellipses as a png. 
  ggsave("Food_D12_FC_cc_f_males60to79_red_Lv2_ord_UNweighted_Axis12_ellipses.png", 
...
# Plot Axis 2 and Axis 3 to show the separation of samples colored by Groups as in the metadata.
  ...
  # Save p1 as a png. 
  ggsave("Food_D12_FC_cc_f_males60to79_red_Lv2_ord_UNweighted_Axis23_p1.png", 
         p1_u, device="png", width=7, height=5.5, unit="in", dpi=300)
  ...
  # Save ellipses as a png. 
  ggsave("Food_D12_FC_cc_f_males60to79_red_Lv2_ord_UNweighted_Axis23_ellipses.png", 
         ellipses_u, device="png", width=7, height=5.5, unit="in", dpi=300)
...
# Plot Axis 3 and Axis 4 to show the separation of samples colored by Groups as in the metadata.
  ...
  # Save p1 as a png. 
  ggsave("Food_D12_FC_cc_f_males60to79_red_Lv2_ord_UNweighted_Axis34_p1.png", 
         p1_u, device="png", width=7, height=5.5, unit="in", dpi=300)
  ...
  # Save ellipses as a png. 
  ggsave("Food_D12_FC_cc_f_males60to79_red_Lv2_ord_UNweighted_Axis34_ellipses.png", 
         ellipses_u, device="png", width=7, height=5.5, unit="in", dpi=300)
...
# Plot Axis 2 and Axis 4 to show the separation of samples colored by Groups as in the metadata.
  ...
  # Save p1 as a png. 
  ggsave("Food_D12_FC_cc_f_males60to79_red_Lv2_ord_UNweighted_Axis24_p1.png", 
         p1_u, device="png", width=7, height=5.5, unit="in", dpi=300)
  ...
  # Save ellipses as a png. 
  ggsave("Food_D12_FC_cc_f_males60to79_red_Lv2_ord_UNweighted_Axis24_ellipses.png", 
         ellipses_u, device="png", width=7, height=5.5, unit="in", dpi=300)
...
# Generate and save an WEIGHTED unifrac distance matrix of "Samples". 
  WeightedUnifracDis(input.phyloseq.obj = phyfoods, 
                     output.fn = "Food_D12_FC_cc_f_males60to79_red_Lv2_ord_WEIGHTED_uni_dis.txt")        

# ---------------------------------------------------------------------------------------------------------------
# Generate and save an UNweighted unifrac distance matrix of "Samples". 
  UnweightedUnifracDis(input.phyloseq.obj = phyfoods, 
                       output.fn = "Food_D12_FC_cc_f_males60to79_red_Lv2_ord_UNweighted_uni_dis.txt")        
