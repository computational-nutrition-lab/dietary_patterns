...
# Create a scree plot.
  ...
  screep
  ggsave("results/PCA_results/temporary/total_d12_mean_QC500_2_screep.pdf", screep, device="pdf", width=5, height=5, units="in")
...
# Create a biplot.
  ...
  biplotdots
  ggsave("results/PCA_results/temporary/total_d12_mean_QC500_2_biplotdots.pdf", biplotdots, device="pdf", width=5, height=5, units="in")
...
# A biplot with the individuals labeled.
  ...
  biplotlabeled
  ggsave("results/PCA_results/temporary/total_d12_mean_QC500_2_biplotlabeled.pdf", biplotlabeled, device="pdf", width=5, height=5, units="in")
...
# A biplot with the individuals labeled without the variables' arrows.
  ...
  ggsave("results/PCA_results/temporary/total_d12_mean_QC500_2_biplotlabeledwoarrows.pdf", biplotlabeledwoarrows, device="pdf", width=5, height=5, units="in")
...
# Plot the directions of the variables.
  ...
  directions
  ggsave("results/PCA_results/temporary/total_d12_mean_QC500_2_directions.pdf", directions, device="pdf", width=5, height=5, units="in")
...
# Plot the contribution of the variables to a given PC.
  ...
  loadings_plot
  ggsave("results/PCA_results/temporary/total_d12_mean_QC500_2_loadings_PC2.pdf", loadings_plot, device="pdf", width=8, height=4.8, units="in")
...
# Change the file name as necessary.  
  SaveVarExplained(pca.data = pca_input, pca.result = scaled_pca, 
                   out.fn = "results/PCA_results/temporary/total_d12_mean_QC500_2_PC_var_explained.txt")
...
# save it as a txt file in the results folder.
  ...
  SaveLoadings(pca.result=scaled_pca, 
               out.fn="results/PCA_results/temporary/total_d12_mean_QC500_2_PC_loadings.txt")
...
# Input is your food input file before any prep for clustering, from which you derived the input for the PCA.
                                          NHANES1516_total_d12_mean_QC_2_500sampled_rv.txt
  SaveInputAndPCs(input = "eg_data/NHANES/NHANES1516_total_d12_mean_QC_2_500sampled.txt",
                  pca.results = scaled_pca, 
                  out.fn = "results/PCA_results/temporary/total_d12_mean_QC500_2_input_PCs.txt")
