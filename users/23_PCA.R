...
# Create a biplot.
  ...
  biplotdots
  ggsave("results/PCA_results/NHANES1516_totalsbyhand_nut_n100/NHANES1516_total_d12_nut_mean_QC_2_100sampled_biplotdots.pdf", biplotdots, device="pdf", width=5, height=5, units="in")
