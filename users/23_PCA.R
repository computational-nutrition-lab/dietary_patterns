...
# Input is your food input file before any prep for clustering, from which you derived the input for the PCA.
  SaveInputAndPCs(input = "eg_data/NHANES/NHANES1516_total_d12_FC_mean_QC_2_98diffdiet.txt",
                  pca.results = scaled_pca, 
                  out.fn = "results/PCA_results/NHANES1516_totalsbyhand_FC_n98/NHANES1516_total_d12_FC_mean_QC_2_98diffdiet_input_PCs.txt")
