# ===============================================================================================================
# Generate food tree out of GLU - males aged 60-79 with food tree level 2 (test)
# Version 1
...
# Load your tree object.
  tree <- read.tree("Food_D12_FC_cc_f_males60to79_red_Lv2.nwk")
...
# Save.
  ggsave("Food_D12_FC_cc_f_males60to79_red_Lv2_viz.pdf", annotated_tree,
