...
# "NodeLabelsMCT.txt" has a list of food levels and names, which comes with this package.
  MakeFoodTree(nodes_fn="../../Food_tree_eg/NodeLabelsMCT.txt", 
               ...
               output_tree_fn =     "Foodtree/Food_D12_FC_cc_f_males60s_red_Lv3.nwk", 
               output_taxonomy_fn = "Foodtree/Food_D12_FC_cc_f_males60s_red_Lv3.taxonomy.txt"
  ) 
...
# Make the standard food otu table with data in gram weights of food.
  MakeFoodOtu(food_records_fn=  "Food_D12_FC_cc_f_males60s.txt",  # need to supply data that have 'FoodAmt' before applying FilterDBByDietRecords.  
              ...
              food_taxonomy_fn= "Foodtree/Food_D12_FC_cc_f_males60s_red_Lv3.taxonomy.txt",  # Your taxonomy file produced by MakeFoodTree.
              output_fn =       "Foodtree/Food_D12_FC_cc_f_males60s_red_Lv3.food.otu.txt")  # Output otu file to be saved.

# Make a food otu table with data in grams of fiber per food
  MakeFiberOtu(food_records_fn=  "Food_D12_FC_cc_f_males60s.txt", 
               food_record_id=   "SEQN", 
               food_taxonomy_fn= "Foodtree/Food_D12_FC_cc_f_males60s_red_Lv3.taxonomy.txt", 
               output_fn=        "Foodtree/Food_D12_FC_cc_f_males60s_red_Lv3.fiber.otu.txt")

# Make a food otu table as dehydrated grams per kcal
  MakeDhydrtOtu(food_records_fn=  "Food_D12_FC_cc_f_males60s.txt", 
                food_record_id =  "SEQN", 
                food_taxonomy_fn= "Foodtree/Food_D12_FC_cc_f_males60s_red_Lv3.taxonomy.txt", 
                output_fn =       "Foodtree/Food_D12_FC_cc_f_males60s_red_Lv3.dhydrt.otu.txt")  
