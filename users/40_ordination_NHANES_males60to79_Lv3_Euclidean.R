...
# Food
  ...
  food <- read.delim("Foodtree/Food_D12_FC_cc_f_males60to79_red_Lv3.dhydrt.otu.txt", row.names=1)
...
#   
# # Save p1 as a png. 
#   ggsave("Food_D12_FC_cc_f_males60to79_red_Lv3_ord_WEIGHTED_Axis12_p1.png", 
...
#   ggsave("Food_D12_FC_cc_f_males60to79_red_Lv3_ord_WEIGHTED_Axis12_ellipses.png", 
...
#   
#   # Save p1 as a png. 
#   ggsave("Food_D12_FC_cc_f_males60to79_red_Lv3_ord_WEIGHTED_Axis23_p1.png", 
#          p1_w, device="png", width=7, height=5.5, unit="in", dpi=300)
#   
#   # You can add ellipses at a desired confidence level; but with this 
#   # example data, there are too few samples per user to draw them. 
...
#   
#   # Save ellipses as a png. 
#   ggsave("Food_D12_FC_cc_f_males60to79_red_Lv3_ord_WEIGHTED_Axis23_ellipses.png", 
#          ellipses_w, device="png", width=7, height=5.5, unit="in", dpi=300)
#   
# # ---------------------------------------------------------------------------------------------------------------
...
#   
#   # Save p1 as a png. 
#   ggsave("Food_D12_FC_cc_f_males60to79_red_Lv3_ord_WEIGHTED_Axis34_p1.png", 
#          p1_w, device="png", width=7, height=5.5, unit="in", dpi=300)
#   
#   # You can add ellipses at a desired confidence level; but with this 
#   # example data, there are too few samples per user to draw them. 
...
#   
#   # Save ellipses as a png. 
#   ggsave("Food_D12_FC_cc_f_males60to79_red_Lv3_ord_WEIGHTED_Axis34_ellipses.png", 
#          ellipses_w, device="png", width=7, height=5.5, unit="in", dpi=300)  
# 
# # ---------------------------------------------------------------------------------------------------------------
...
#   
#   # Save p1 as a png. 
#   ggsave("Food_D12_FC_cc_f_males60to79_red_Lv3_ord_WEIGHTED_Axis24_p1.png", 
#          p1_w, device="png", width=7, height=5.5, unit="in", dpi=300)
#   
#   # You can add ellipses at a desired confidence level; but with this 
#   # example data, there are too few samples per user to draw them. 
...
#   
#   # Save ellipses as a png. 
#   ggsave("Food_D12_FC_cc_f_males60to79_red_Lv3_ord_WEIGHTED_Axis24_ellipses.png", 
#          ellipses_w, device="png", width=7, height=5.5, unit="in", dpi=300)  
...
# Save it as a txt file.
  write.table(as.matrix(dist_matrix_e), "Food_D12_FC_cc_f_males60to79_red_Lv3_Euclidean_dis.txt", 
...
# Pick up only those in food3 from demog_glu. 
  demog_glu_male60to79 <-  demog_glu[TF, ]
  head(rownames(demog_glu_male60to79))
...
# If this is not true, the tests below will be incorrect.
  identical(colnames(as.matrix(dist_matrix_e)), rownames(demog_glu_male60to79))
  
# ---------------------------------------------------------------------------------------------------------------
# Dispersion test and plot
  # vegan::betadisper computes centeroids and distance of each datapoint from it. 
  dispr_e <- vegan::betadisper(d= dist_matrix_e, demog_glu_male60to79$GLU_index)
...
# adonis test with food3_s (sorted OTU) as the response and GLU_index of the individuals as the explanatory variable.   
  adonis(formula = food3_s ~ demog_glu_male60to79$GLU_index, method = "euclidean", permutations = 5000)
