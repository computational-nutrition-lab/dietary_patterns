# ===============================================================================================================
# Generate food tree out of GLU - males aged 60-79 with food tree level 0 (test)
# Version 1
...
# Load your tree object.
  tree <- read.tree("Food_D12_FC_cc_f_males60to79_red_Lv0.nwk")
...
# Save.
  ggsave("Food_D12_FC_cc_f_males60to79_red_Lv0_viz.pdf", annotated_tree,
