# ===============================================================================================================
# Create a phyloseq object out of dietary and tree data and run ordination. Tree level Lv3
...
# Save p1 as a PDF. 
  ggsave("Food_D12_FC_cc_f_males60s_red_Lv3_ord_WEIGHTED_Axis12_p1.pdf", 
...
# Save ellipses as a PDF. 
  ggsave("Food_D12_FC_cc_f_males60s_red_Lv3_ord_WEIGHTED_Axis12_ellipses.pdf", 
...
# Plot Axis 2 and Axis 3 to show the separation of samples colored by Groups as in the metadata.
  ...
  # Save p1 as a PDF. 
  ggsave("Food_D12_FC_cc_f_males60s_red_Lv3_ord_WEIGHTED_Axis23_p1.pdf", 
         p1_w, device="pdf", width=7, height=5.5, unit="in", dpi=300)
  ...
  # Save ellipses as a PDF. 
  ggsave("Food_D12_FC_cc_f_males60s_red_Lv3_ord_WEIGHTED_Axis23_ellipses.pdf", 
         ellipses_w, device="pdf", width=7, height=5.5, unit="in", dpi=300)
...
# Plot Axis 3 and Axis 4 to show the separation of samples colored by Groups as in the metadata.
  ...
  # Save p1 as a PDF. 
  ggsave("Food_D12_FC_cc_f_males60s_red_Lv3_ord_WEIGHTED_Axis34_p1.pdf", 
         p1_w, device="pdf", width=7, height=5.5, unit="in", dpi=300)
  ...
  # Save ellipses as a PDF. 
  ggsave("Food_D12_FC_cc_f_males60s_red_Lv3_ord_WEIGHTED_Axis34_ellipses.pdf", 
         ellipses_w, device="pdf", width=7, height=5.5, unit="in", dpi=300)  
...
# Plot Axis 2 and Axis 4 to show the separation of samples colored by Groups as in the metadata.
  ...
  # Save p1 as a PDF. 
  ggsave("Food_D12_FC_cc_f_males60s_red_Lv3_ord_WEIGHTED_Axis24_p1.pdf", 
         p1_w, device="pdf", width=7, height=5.5, unit="in", dpi=300)
  ...
  # Save ellipses as a PDF. 
  ggsave("Food_D12_FC_cc_f_males60s_red_Lv3_ord_WEIGHTED_Axis24_ellipses.pdf", 
         ellipses_w, device="pdf", width=7, height=5.5, unit="in", dpi=300)  
...
# Save p1 as a PDF. 
  ggsave("Food_D12_FC_cc_f_males60s_red_Lv3_ord_UNweighted_Axis12_p1.pdf", 
...
# Save ellipses as a PDF. 
  ggsave("Food_D12_FC_cc_f_males60s_red_Lv3_ord_UNweighted_Axis12_ellipses.pdf", 
