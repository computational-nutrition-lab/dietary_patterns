# ===============================================================================================================
# Generate food tree out of GLU - males in their 60s with food level 6 (test)
# Version 1
...
# Load your tree object.
  tree <- read.tree("Food_D12_FC_cc_f_males50s_red_Lv6.nwk")
...
# Save.
  ggsave("Food_D12_FC_cc_f_males50s_red_Lv6_viz.pdf", annotated_tree,
...
# It's possible to visualize Lv6 food tree, but it's not possible to do ordination with Lv6...??  